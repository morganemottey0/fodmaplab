          ...
          <div className="flex gap-2">
            {DAYS_OPTIONS.map((d) => (
              <button
                ...
                style={{
                  background: days === d ? "var(--primary-light)" : "var(--surface)",
                  borderColor: days === d ? "var(--primary)" : "var(--primary-border)",
                  ...
                  {MEAL_LABELS.map(({ key, label }) => (
                    <div key={key} className="card">
                      ...
                      <p className="text-xs mb-2" style={{ color: "var(--text-muted)" }}>
                        {day[key].ingredients.join(" · ")}
                      </p>
                      <div className="rounded-xl px-3 py-2" style={{ background: "var(--primary-light)" }}>
